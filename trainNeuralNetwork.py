...
UPLOAD_FOLDER_DATA_TO_TRAIN = join(dirname(realpath(__file__)), 'static/dataToTrain/')
...
class NeuralNetwork:
    ...
    def save_weights(self):
        ...
        numpy.savetxt(str(UPLOAD_FOLDER_TRAINED_DATA) + 'input_to_hidden.csv', self.weight_input_hidden, delimiter=',')
        numpy.savetxt(str(UPLOAD_FOLDER_TRAINED_DATA) + 'hidden_to_output.csv', self.weight_hidden_output, delimiter=',')
